...
pub impl MoveEventEntityStoreImpl of MoveEventEntityStore {
    ...
    fn update(self: @MoveEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<MoveEventEntity>::update_entity(self, world);
    }

    fn delete(self: @MoveEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<MoveEventEntity>::delete_entity(self, world);
    }
...
pub impl MoveEventStoreImpl of MoveEventStore {
    ...
    fn set(self: @MoveEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<MoveEvent>::set_model(self, world);
    }

    fn delete(self: @MoveEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<MoveEvent>::delete_model(self, world);
    }
...
pub impl MoveEventModelEntityImpl of dojo::model::ModelEntity<MoveEventEntity> {
    ...
    fn update_entity(self: @MoveEventEntity, world: dojo::world::IWorldDispatcher) {
    ...
    fn delete_entity(self: @MoveEventEntity, world: dojo::world::IWorldDispatcher) {
...
pub impl MoveEventModelImpl of dojo::model::Model<MoveEvent> {
    ...
    fn set_model(self: @MoveEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::set_entity(
            world,
            Self::selector(),
    ...
    fn delete_model(self: @MoveEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::delete_entity(
