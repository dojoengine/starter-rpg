...
pub impl HealEventEntityStoreImpl of HealEventEntityStore {
    ...
    fn update(self: @HealEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<HealEventEntity>::update_entity(self, world);
    }

    fn delete(self: @HealEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<HealEventEntity>::delete_entity(self, world);
    }
...
pub impl HealEventStoreImpl of HealEventStore {
    ...
    fn set(self: @HealEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<HealEvent>::set_model(self, world);
    }

    fn delete(self: @HealEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<HealEvent>::delete_model(self, world);
    }
...
pub impl HealEventModelEntityImpl of dojo::model::ModelEntity<HealEventEntity> {
    ...
    fn update_entity(self: @HealEventEntity, world: dojo::world::IWorldDispatcher) {
    ...
    fn delete_entity(self: @HealEventEntity, world: dojo::world::IWorldDispatcher) {
...
pub impl HealEventModelImpl of dojo::model::Model<HealEvent> {
    ...
    fn set_model(self: @HealEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::set_entity(
            world,
            Self::selector(),
    ...
    fn delete_model(self: @HealEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::delete_entity(
