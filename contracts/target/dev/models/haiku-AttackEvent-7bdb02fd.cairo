...
pub impl AttackEventEntityStoreImpl of AttackEventEntityStore {
    ...
    fn update(self: @AttackEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<AttackEventEntity>::update_entity(self, world);
    }

    fn delete(self: @AttackEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<AttackEventEntity>::delete_entity(self, world);
    }
...
pub impl AttackEventStoreImpl of AttackEventStore {
    ...
    fn set(self: @AttackEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<AttackEvent>::set_model(self, world);
    }

    fn delete(self: @AttackEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<AttackEvent>::delete_model(self, world);
    }
...
pub impl AttackEventModelEntityImpl of dojo::model::ModelEntity<AttackEventEntity> {
    ...
    fn update_entity(self: @AttackEventEntity, world: dojo::world::IWorldDispatcher) {
    ...
    fn delete_entity(self: @AttackEventEntity, world: dojo::world::IWorldDispatcher) {
...
pub impl AttackEventModelImpl of dojo::model::Model<AttackEvent> {
    ...
    fn set_model(self: @AttackEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::set_entity(
            world,
            Self::selector(),
    ...
    fn delete_model(self: @AttackEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::delete_entity(
