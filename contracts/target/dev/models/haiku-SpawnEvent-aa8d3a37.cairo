...
pub impl SpawnEventEntityStoreImpl of SpawnEventEntityStore {
    ...
    fn update(self: @SpawnEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<SpawnEventEntity>::update_entity(self, world);
    }

    fn delete(self: @SpawnEventEntity, world: dojo::world::IWorldDispatcher) {
        dojo::model::ModelEntity::<SpawnEventEntity>::delete_entity(self, world);
    }
...
pub impl SpawnEventStoreImpl of SpawnEventStore {
    ...
    fn set(self: @SpawnEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<SpawnEvent>::set_model(self, world);
    }

    fn delete(self: @SpawnEvent, world: dojo::world::IWorldDispatcher) {
        dojo::model::Model::<SpawnEvent>::delete_model(self, world);
    }
...
pub impl SpawnEventModelEntityImpl of dojo::model::ModelEntity<SpawnEventEntity> {
    ...
    fn update_entity(self: @SpawnEventEntity, world: dojo::world::IWorldDispatcher) {
    ...
    fn delete_entity(self: @SpawnEventEntity, world: dojo::world::IWorldDispatcher) {
...
pub impl SpawnEventModelImpl of dojo::model::Model<SpawnEvent> {
    ...
    fn set_model(self: @SpawnEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::set_entity(
            world,
            Self::selector(),
    ...
    fn delete_model(self: @SpawnEvent, world: dojo::world::IWorldDispatcher) {
        dojo::world::IWorldDispatcherTrait::delete_entity(
